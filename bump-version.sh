...
cp gh-repos-csv.phar downloads/gh-repos-csv-${TAG}.phar
git add downloads/gh-repos-csv-${TAG}.phar

SHA1=$(openssl sha1 gh-repos-csv.phar)

JSON='name:"gh-repos-csv.phar"'
JSON="${JSON},sha1:\"${SHA1}\""
JSON="${JSON},url:\"http://hauntd.github.io/gh-repos-csv/downloads/gh-repos-csv-${TAG}.phar\""
JSON="${JSON},version:\"${TAG}\""

if [ -f gh-repos-csv.phar.pubkey ]; then
    cp gh-repos-csv.phar.pubkey pubkeys/gh-repos-csv-${TAG}.phar.pubkeys
    git add pubkeys/gh-repos-csv-${TAG}.phar.pubkeys
    JSON="${JSON},publicKey:\"http://hauntd.github.io/gh-repos-csv/pubkeys/gh-repos-csv-${TAG}.phar.pubkey\""
fi
